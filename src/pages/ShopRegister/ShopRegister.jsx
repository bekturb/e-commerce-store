                            ...
                            <form className="form" onSubmit={onSubmit}>
                                ...
                                <div className="form__fields">
                                    ...
                                    <p className="form__field">
                                        <label>
                                            <input
                                                className={formErrors.name ? "form__input-color" : "form__input"}
                                                type="text"
                                                name="firstName"
                                                value={formData.name}
                                                placeholder='Name*'
                                        ...
                                        {formErrors.name &&
                                            <span className="error form__error">*{formErrors.name}</span>}
                                    </p>
                                    <p className="form__field">
                                        <label>
                                            <input
                                        ...
                                        {formErrors.password &&
                                            <span className="error form__error">*{formErrors.password}</span>}
                                    </p>
                                    <p className="form__field">
                                        <label>
                                            <input
                                    ...
                                    <p className="form__field">
                                        <label>
                                            <input
                                                className={formErrors.address ? "form__input-color" : "form__input"}
                                                type="text"
                                                name="phoneNumber"
                                        ...
                                        {formErrors.address &&
                                            <span className="error form__error">*{formErrors.address}</span>}
                                    </p>
                                    <p className="form__field">
                                        <label>
                                            <input
                                                className={formErrors.zipCode ? "form__input-color" : "form__input"}
                                                type="text"
                                                name="phoneNumber"
                                        ...
                                        {formErrors.zipCode &&
                                            <span className="error form__error">*{formErrors.zipCode}</span>}
                                    </p>
