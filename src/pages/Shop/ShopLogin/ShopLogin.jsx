          ...
          <div className="register__wrapper">
            ...
            <div className="register__glass">
              <div className="register__head">
                <h4 className="register__title">Seller Login</h4>
              ...
              <form className="form" onSubmit={onSubmit}>
                ...
                <div className="form__exist">
                  <div className="form__question">
                    Not a Member?
                    <Link className="form__link" to="/shop/register">
                      Register Now
                    </Link>
                  </div>
                  <div className="form__question">
                    <Link className="form__link form__link-forget--password" to="/forget-password/confirmation/seller">
                      Forget Password
                    </Link>
                  </div>
                </div>
